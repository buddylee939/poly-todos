...
class TodoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post todo_items_url, params: { todo_item: { completed_at: @todo_item.completed_at, notes: @todo_item.notes, response: @todo_item.response, task: @todo_item.task, todo_list_id: @todo_item.todo_list_id, user_id: @todo_item.user_id } }
    end
  ...
  test "should update todo_item" do
    patch todo_item_url(@todo_item), params: { todo_item: { completed_at: @todo_item.completed_at, notes: @todo_item.notes, response: @todo_item.response, task: @todo_item.task, todo_list_id: @todo_item.todo_list_id, user_id: @todo_item.user_id } }
